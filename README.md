...
- [Пример автоматического создания](https://github.com/KlestovAlexej/Wattle3.DemoServer/blob/d209439e8593eb4a0f80ddb5f02609ba45b7ce6c/tests/DemoServer.Processing.Tests.DataAccess.Postgresql/TestsCreateEmptyDb.cs#L33) [контекста](src/DemoServer.Processing.DataAccess.Postgresql/EfModels) и [оптимизированной модели контекста](src/DemoServer.Processing.DataAccess.Postgresql/EfModelsOptimized) Entity Framework по существующей БД с полным переписыванием предыдущих моделей (полезно если сущности БД удалены или переименованы)
